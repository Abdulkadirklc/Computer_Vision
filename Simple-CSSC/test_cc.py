...
from evaluate.metrics_for_cc import evaluate_prcc_all_gallery

# Makes test time augmentation
...
def test_for_prcc(args, query_sc_loader, query_cc_loader, gallery_loader, model,
    ...
    model.eval()
    # Print same cloth re-ID results
    print("Same cloth re-ID results: \n")
    ...
    print("Changed cloth re-ID results: \n")
